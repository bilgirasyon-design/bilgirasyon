...
function injectBeforeArticle(html, breadcrumbHtml) {
  ...
  if (html.includes('class="breadcrumb"')) return html;
...
function injectSchema(html, schema) {
  ...
  return html.replace(
    marker,
    `\n  <script type="application/ld+json" data-bilgiration-schema="breadcrumb">\n${schema}\n  </script>\n${marker}`
  );
}
...
async function run() {
  ...
  for (const article of articles) {
    ...
    if (!html.includes('data-bilgiration-schema="breadcrumb"')) {
